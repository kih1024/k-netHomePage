app.post('/post/:post_type/:post_number', isAuthenticated, function(req, res) {
    ...
    // get values
    var content_body = req.body.content_editor;
    ...
    transfer.transfer(post_type, function(type_name){
      ...
      var folder_path = __dirname + '/../public/uploads/' + post_type + '/' + post_number;
      var filePath = __dirname + '/../public/uploads/' + post_type + '/' + post_number + "/0.txt";
      var firstSample = content_body;
